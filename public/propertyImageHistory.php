...
function ciniki_propertyrentals_propertyImageHistory($ciniki) {
    ...
    $rc = ciniki_propertyrentals_checkAccess($ciniki, $args['tnid'], 'ciniki.propertyrentals.propertyImageHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.propertyrentals', 'ciniki_propertyrental_history', 
        $args['tnid'], 'ciniki_propertyrental_images', $args['property_image_id'], $args['field']);
}
?>
