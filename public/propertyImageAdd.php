...
function ciniki_propertyrentals_propertyImageAdd(&$ciniki) {
    ...
    $rc = ciniki_propertyrentals_checkAccess($ciniki, $args['tnid'], 'ciniki.propertyrentals.propertyImageAdd'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    } 
    ...
    return ciniki_core_objectAdd($ciniki, $args['tnid'], 'ciniki.propertyrentals.image', $args, 0x07);
}
?>
